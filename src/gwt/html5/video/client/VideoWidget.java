package gwt.html5.video.client;
...
import gwt.html5.video.client.VideoSource.VideoType;
import gwt.html5.video.client.dom.VideoElement;
import gwt.html5.video.client.dom.VideoSourceElement;
import gwt.html5.video.client.events.VideoAbortEvent;
import gwt.html5.video.client.events.VideoCanPlayEvent;
...
import gwt.html5.video.client.handlers.HasVideoHandlers;
import gwt.html5.video.client.handlers.VideoAbortHandler;
...
import gwt.html5.video.client.handlers.VideoDurationChangeHandler;
import gwt.html5.video.client.handlers.VideoEmptyHandler;
import gwt.html5.video.client.handlers.VideoEndedHandler;
...
import gwt.html5.video.client.handlers.VideoLoadStartHandler;
import gwt.html5.video.client.handlers.VideoPauseHandler;
import gwt.html5.video.client.handlers.VideoPlayHandler;
import gwt.html5.video.client.handlers.VideoPlayingHandler;
import gwt.html5.video.client.handlers.VideoProgressHandler;
import gwt.html5.video.client.handlers.VideoRateChangeHandler;
import gwt.html5.video.client.handlers.VideoSeekedHandler;
import gwt.html5.video.client.handlers.VideoSeekingHandler;
import gwt.html5.video.client.handlers.VideoStalledHandler;
import gwt.html5.video.client.handlers.VideoSuspendHandler;
import gwt.html5.video.client.handlers.VideoTimeUpdateHandler;
import gwt.html5.video.client.handlers.VideoVolumeChangeHandler;
...
public class VideoWidget extends Widget implements HasVideoHandlers {
    ...
    private final native void addAbortEventHandler() /*-{
                                                     var videoElement = this.@gwt.html5.video.client.VideoWidget::videoElement;
                                                     var videoWidget = this;
                                                     videoElement
                                                     .addEventListener(
                                                     'abort',
                                                     function() {
                                                     var event = @gwt.html5.video.client.events.VideoAbortEvent::new()();
                                                     videoWidget.@gwt.html5.video.client.VideoWidget::fireEvent(Ljava/lang/Object;)(event);
                                                     }, true);
                                                     }-*/;
    ...
    private final native void addCanPlayEventHandler() /*-{
                                                       ...
                                                       'canplay',
                                                       function() {
                                                       var event = @gwt.html5.video.client.events.VideoCanPlayEvent::new()();
                                                       videoWidget.@gwt.html5.video.client.VideoWidget::fireEvent(Ljava/lang/Object;)(event);
                                                       }, true);
                                                       }-*/;
    ...
    private final native void addCanPlayThroughEventHandler() /*-{
                                                              ...
                                                              'canplaythrough',
                                                              function() {
                                                              var event = @gwt.html5.video.client.events.VideoCanPlayThroughEvent::new()();
                                                              videoWidget.@gwt.html5.video.client.VideoWidget::fireEvent(Ljava/lang/Object;)(event);
                                                              }, true);
                                                              }-*/;
    ...
    private final native void addDurationChangeEventHandler() /*-{
                                                              ...
                                                              'durationchange',
                                                              function() {
                                                              var event = @gwt.html5.video.client.events.VideoDurationChangeEvent::new()();
                                                              videoWidget.@gwt.html5.video.client.VideoWidget::fireEvent(Ljava/lang/Object;)(event);
                                                              }, true);
                                                              }-*/;
    ...
    private final native void addEmptyEventHandler() /*-{
                                                     ...
                                                     'emptied',
                                                     function() {
                                                     var event = @gwt.html5.video.client.events.VideoEmptyEvent::new()();
                                                     videoWidget.@gwt.html5.video.client.VideoWidget::fireEvent(Ljava/lang/Object;)(event);
                                                     }, true);
                                                     }-*/;
    ...
    private final native void addEndedEventHandler() /*-{
                                                     ...
                                                     'ended',
                                                     function() {
                                                     var event = @gwt.html5.video.client.events.VideoEndedEvent::new()();
                                                     videoWidget.@gwt.html5.video.client.VideoWidget::fireEvent(Ljava/lang/Object;)(event);
                                                     }, true);
                                                     }-*/;
    ...
    private final native void addErrorEventHandler() /*-{
                                                     ...
                                                     'error',
                                                     function() {
                                                     var event = @gwt.html5.video.client.events.VideoErrorEvent::new()();
                                                     videoWidget.@gwt.html5.video.client.VideoWidget::fireEvent(Ljava/lang/Object;)(event);
                                                     }, true);
                                                     }-*/;
    ...
    private final native void addLoadDataEventHandler() /*-{
                                                        ...
                                                        'loadeddata',
                                                        function() {
                                                        var event = @gwt.html5.video.client.events.VideoLoadDataEvent::new()();
                                                        videoWidget.@gwt.html5.video.client.VideoWidget::fireEvent(Ljava/lang/Object;)(event);
                                                        }, true);
                                                        }-*/;
    ...
    private final native void addLoadMetadataEventHandler() /*-{
                                                            ...
                                                            'loadedmetadata',
                                                            function() {
                                                            var event = @gwt.html5.video.client.events.VideoLoadMetadataEvent::new()();
                                                            videoWidget.@gwt.html5.video.client.VideoWidget::fireEvent(Ljava/lang/Object;)(event);
                                                            }, true);
                                                            }-*/;
    ...
    private final native void addLoadStartEventHandler() /*-{
                                                         ...
                                                         'loadstart',
                                                         function() {
                                                         var event = @gwt.html5.video.client.events.VideoLoadStartEvent::new()();
                                                         videoWidget.@gwt.html5.video.client.VideoWidget::fireEvent(Ljava/lang/Object;)(event);
                                                         }, true);
                                                         }-*/;
    ...
    private final native void addPauseEventHandler() /*-{
                                                     ...
                                                     'pause',
                                                     function() {
                                                     var event = @gwt.html5.video.client.events.VideoPauseEvent::new()();
                                                     videoWidget.@gwt.html5.video.client.VideoWidget::fireEvent(Ljava/lang/Object;)(event);
                                                     }, true);
                                                     }-*/;
    ...
    private final native void addPlayEventHandler() /*-{
                                                    ...
                                                    'play',
                                                    function() {
                                                    var event = @gwt.html5.video.client.events.VideoPlayEvent::new()();
                                                    videoWidget.@gwt.html5.video.client.VideoWidget::fireEvent(Ljava/lang/Object;)(event);
                                                    }, true);
                                                    }-*/;
    ...
    private final native void addPlayingEventHandler() /*-{
                                                       ...
                                                       'playing',
                                                       function() {
                                                       var event = @gwt.html5.video.client.events.VideoPlayingEvent::new()();
                                                       videoWidget.@gwt.html5.video.client.VideoWidget::fireEvent(Ljava/lang/Object;)(event);
                                                       }, true);
                                                       }-*/;
    ...
    private final native void addProgressEventHandler() /*-{
                                                        ...
                                                        'progress',
                                                        function() {
                                                        var event = @gwt.html5.video.client.events.VideoProgressEvent::new()();
                                                        videoWidget.@gwt.html5.video.client.VideoWidget::fireEvent(Ljava/lang/Object;)(event);
                                                        }, true);
                                                        }-*/;
    ...
    private final native void addRateChangeEventHandler() /*-{
                                                          ...
                                                          'ratechange',
                                                          function() {
                                                          var event = @gwt.html5.video.client.events.VideoRateChangeEvent::new()();
                                                          videoWidget.@gwt.html5.video.client.VideoWidget::fireEvent(Ljava/lang/Object;)(event);
                                                          }, true);
                                                          }-*/;
    ...
    private final native void addSeekedEventHandler() /*-{
                                                      ...
                                                      'seeked',
                                                      function() {
                                                      var event = @gwt.html5.video.client.events.VideoSeekedEvent::new()();
                                                      videoWidget.@gwt.html5.video.client.VideoWidget::fireEvent(Ljava/lang/Object;)(event);
                                                      }, true);
                                                      }-*/;
    ...
    private final native void addSeekingEventHandler() /*-{
                                                       ...
                                                       'seeking',
                                                       function() {
                                                       var event = @gwt.html5.video.client.events.VideoSeekingEvent::new()();
                                                       videoWidget.@gwt.html5.video.client.VideoWidget::fireEvent(Ljava/lang/Object;)(event);
                                                       }, true);
                                                       }-*/;
    ...
    private final native void addStalledEventHandler() /*-{
                                                       ...
                                                       'stalled',
                                                       function() {
                                                       var event = @gwt.html5.video.client.events.VideoStalledEvent::new()();
                                                       videoWidget.@gwt.html5.video.client.VideoWidget::fireEvent(Ljava/lang/Object;)(event);
                                                       }, true);
                                                       }-*/;
    ...
    private final native void addSuspendEventHandler() /*-{
                                                       ...
                                                       'suspend',
                                                       function() {
                                                       var event = @gwt.html5.video.client.events.VideoSuspendEvent::new()();
                                                       videoWidget.@gwt.html5.video.client.VideoWidget::fireEvent(Ljava/lang/Object;)(event);
                                                       }, true);
                                                       }-*/;
    ...
    private final native void addTimeUpdateEventHandler() /*-{
                                                          ...
                                                          var event = @gwt.html5.video.client.events.VideoTimeUpdateEvent::new()();
                                                          event.@gwt.html5.video.client.events.VideoTimeUpdateEvent::setCurrentTime(D)(currentTime);
                                                          event.@gwt.html5.video.client.events.VideoTimeUpdateEvent::setDuration(D)(duration);
                                                          videoWidget.@gwt.html5.video.client.VideoWidget::fireEvent(Ljava/lang/Object;)(event);
                                                          }, true);
                                                          }-*/;
    ...
    private final native void addVolumeChangeEventHandler() /*-{
                                                            ...
                                                            'volumechange',
                                                            function() {
                                                            var event = @gwt.html5.video.client.events.VideoVolumeChangeEvent::new()();
                                                            videoWidget.@gwt.html5.video.client.VideoWidget::fireEvent(Ljava/lang/Object;)(event);
                                                            }, true);
                                                            }-*/;
    ...
    private final native void addWaitingEventHandler() /*-{
														...
														'waiting',
														function() {
														var event = @gwt.html5.video.client.events.VideoWaitingEvent::new()();
														videoWidget.@gwt.html5.video.client.VideoWidget::fireEvent(Ljava/lang/Object;)(event);
														}, true);
														}-*/;
